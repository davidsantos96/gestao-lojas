...
export function ModalLancamento({ lancamento, onClose, onSubmit }) {
  ...
  const CATEGORIAS_COM_PRODUTO = ['Venda Balcão', 'Venda Online']

  const handleCategoria = (value) => {
    set('categoria', value)
    if (CATEGORIAS_COM_PRODUTO.includes(value)) {
      ...
      <ModalContainer>
        ...
        <FormWrap>
          ...
          <FieldWrap>
            ...
            <Select value={form.categoria} onChange={e => handleCategoria(e.target.value)} disabled={loading}>
